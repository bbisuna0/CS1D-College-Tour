#ifndef SOUVENIRDISPLAY_H
#define SOUVENIRDISPLAY_H
...
/**
 * @class SouvenirDisplay
 * @brief Dialog for displaying and managing souvenir data.
 *
 * This class provides an interface for viewing, adding, editing, and deleting
 * souvenirs associated with different colleges.
 */
class SouvenirDisplay : public QDialog {
    Q_OBJECT

public:
    /**
     * @brief Constructs the SouvenirDisplay dialog.
     * @param souvenirList Reference to a list of souvenir data.
     * @param parent Optional parent widget.
     */
    explicit SouvenirDisplay(std::vector<SouvenirData>& souvenirList, QWidget* parent = nullptr);
